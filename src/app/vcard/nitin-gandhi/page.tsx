...
import { Phone, Mail, MapPin, Youtube, Globe, MessageCircle, Download, User } from "lucide-react";

export default function NitinGandhiVCard() {
...
END:VCARD`;
    ...
    link.href = url;
    link.download = "Nitin_Gandhi.vcf";
      ...
      >
        ...
        <div className="vcard-header relative h-64 overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-end pb-6">
            <h1 className="text-3xl font-bold text-white mb-2 drop-shadow-lg">Nitin Gandhi</h1>
        ...
        <div className="p-6 space-y-4">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-white font-medium">+91 9769660363</p>
            </div>
          </a>

          {/* Email */}
          <a
            href="mailto:ntngandhi65@gmail.com"
            className="vcard-info flex items-center gap-4 p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all group backdrop-blur-sm"
          >
            <div className="w-12 h-12 rounded-full bg-[#3B82F6]/10 flex items-center justify-center group-hover:bg-[#3B82F6]/20 transition-colors border border-[#3B82F6]/20">
            ...
            <div className="flex-1">
              ...
              <p className="text-white font-medium text-sm">ntngandhi65@gmail.com</p>
            </div>
          </a>
          ...
          <div className="space-y-3">
            {/* WhatsApp */}
            <a
              href={`https://wa.me/919769660363?text=${whatsappMessage}`}
              target="_blank"
              rel="noopener noreferrer"
