...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with Forever Consultants — 15x MDRT qualifier & Care Health Champion advisors. Book a free personal consultation for LIC Insurance, Mutual Funds, or Health Insurance in Mumbai. ₹50Cr+ AUM managed.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Request a personal visit from award-winning advisors (15x MDRT, Care Health Champion). LIC Insurance, Mutual Funds & Health Insurance consultation in Mumbai.",
